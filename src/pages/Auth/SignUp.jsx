        ...
        <div className="w-2/4 h-[90vh] flex items-end bg-signup-bg-img bg-cover bg-center rounded-lg p-10 z-50">
          <div>
            <h4 className='text-3xl text-black font-bold leading-[50px]'>
              Join the <br />Journeys
              </h4>
            <p className='text-[15px] text-black leading-6 pr-7 mt-4 '>
              Start capturing your journey experiences and unforgettable memories with your own personal travel journal.
            </p>
          </div>
        </div>

        <div className='w-2/4 h-[90vh] ml-10 bg-white rounded-r-lg relative p-16 shadow-lg shadow-cyan-200/20'>
